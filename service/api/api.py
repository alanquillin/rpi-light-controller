...
api.add_resource(Device, "/api/v1/devices/<device_id>")
api.add_resource(DeviceExtendedDetails, "/api/v1/devices/<device_id>/extended_details")
api.add_resource(DeviceStatus, "/api/v1/devices/<device_id>/status")
api.add_resource(DeviceZones, "/api/v1/devices/<device_id>/zones")
api.add_resource(DeviceZone, "/api/v1/devices/<device_id>/zones/<zone_id>")
api.add_resource(DeviceZonePin, "/api/v1/devices/<device_id>/zones/<zone_id>/pins/<pin_num>")
api.add_resource(Zones, "/api/v1/zones")
api.add_resource(Zone, "/api/v1/zones/<zone_id>")
api.add_resource(ZoneDevices, "/api/v1/zones/<zone_id>/devices")
api.add_resource(ZoneDevice, "/api/v1/zones/<zone_id>/devices/<device_id>")
api.add_resource(ZoneState, "/api/v1/zones/<zone_id>/<state>")
